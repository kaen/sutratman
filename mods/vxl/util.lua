function vxl.pick_one(t)
  return t[math.random(#t)]
end

function vxl.pick_from_hash(t)
  local keys = { }
...
function vxl.pick_random_2d_point()
end

function vxl.get_uuid()
  vxl.data.last_uuid = (vxl.data.last_uuid or 0) + 1
  return vxl.data.last_uuid
end

function vxl.assert(x)
  assert(x)
end

function vxl.equals(a,b)
  if type(a) == 'table' and type(b) == 'table' then
    for k,v in pairs(a) do
      if not vxl.equals(a[k],b[k]) then return false end
    end
    return true
  end
  return a == b
...
function vxl.line_of_sight(a, b)
